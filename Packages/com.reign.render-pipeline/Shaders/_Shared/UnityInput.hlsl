...
/*// Vulkan SwapChain preTransform (not used in custom Render-Pipelines)
...
/*switch (UNITY_DISPLAY_ORIENTATION_PRETRANSFORM)// example
{
    case UNITY_DISPLAY_ORIENTATION_PRETRANSFORM_90: p = float2(-p.y, p.x); break;
    case UNITY_DISPLAY_ORIENTATION_PRETRANSFORM_180: p = -p; break;
    case UNITY_DISPLAY_ORIENTATION_PRETRANSFORM_270: p = float2(p.y, -p.x); break;
}*/
