Shader "ReignRP/Lit Transparent (OpaquePass)"
{
    Properties
    {
        // Blend Options
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #if defined(_COLOR_TEXTURE) || defined(_COLOR_BOTH) || defined(_SPECULAR_MAP) || defined(ENABLE_NORMAL) || defined(ENABLE_OCCLUSION) || defined(ENABLE_EMISSION)
            #define ENABLE_UV
            #endif
